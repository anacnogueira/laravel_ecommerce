    ...
    @php
        ...
        foreach($orders  as $key => $order) {
            $data[$key] = [
                ...
                '<nobr><a href="'. route('admin.orders.edit', $order->id).'" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar">
