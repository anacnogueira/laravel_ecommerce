...
@section('content')
    ...
    @php
        ...
        foreach($coupons  as $key => $coupon) {
            $status = $statusChange->returnStatusBullets("coupons", $coupon->status, $coupon->id);
            $data[$key] = [
                $coupon->id,
                $coupon->name,
                $coupon->code,
                ...
                $coupon->to_date,
                $status,
                '<nobr><a href="'. route('admin.coupons.edit', $coupon->id).'" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar">
                ...
                <a href="'.route('admin.coupons.show', $coupon->id) .'" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Detalhes">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header"> <a href="{{ route('admin.coupons.create') }}" class="btn btn-sm btn-primary">
                    <i class="fa fa-lg fa-fw fa-file"></i> Adicionar
                </a></div>
                <div class="card-body">
                    <x-adminlte-datatable id="table-coupon" :heads="$heads" head-theme="light" hoverable bordered with-buttons>
