    ...
    <div class="col-md-12">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $log->created }}</td>
                    <td>{{ $log->client_notified == 'S' ? 'Sim' : 'Não' }}</td>
                    <td>{{ $log->client_comment == 'S' ? 'Sim' : 'Não' }}</td>
...
<a href="{{ route('admin.customers.orders.index', $order->contact_id, $order->id) }}" class="btn btn-warning"><i class="fa fa-times"></i> Voltar</a>
