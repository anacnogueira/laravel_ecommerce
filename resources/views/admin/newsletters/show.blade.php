...
@section('title', 'Visualizar Newsletter')

@section('content_header')
    <h1>Visualizar Newsletter</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    <dl>
                        @if ($newsletter->contact_id)
                            <dt>Cliente:</dt>
                            <dd>{{ $newsletter->contact->name }}&nbsp;</dd>
                        @endif
                        <dt>E-mail:</dt>
                    ...
                    <div class="row" style="margin-top: 20px">
                        <div class="col-md-12">
                            <div class="btn-group" style="display: inline">
                                    <a href="{{ route('admin.newsletters.edit', $newsletter->id) }}" class="btn btn-success">
                                    ...
                                    <a href="{{ route('admin.newsletters.index') }}" class="btn btn-warning">
