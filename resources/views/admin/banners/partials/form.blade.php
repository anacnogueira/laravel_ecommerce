...
<x-adminlte-input name="name" label="Name:*" value="{{ $banner->name ?? ''}}" placeholder="Insira nome do banner" enable-old-support/>
...
<x-adminlte-input name="dimension" label="Tamanho:" placeholder="Insira o tamanho dobanner no formato alturaXlargura" value="{{ $banner ? $banner->dimension : ''}}" enable-old-support/>
<x-adminlte-input name="url" label="Link:" placeholder="Insira o link do banner" value="{{ $banner ? $banner->url : ''}}" enable-old-support/>
...
<div class="row">
    <x-adminlte-input-date name="scheduled_date" :config="$config" placeholder="Escolha a data"
        label="Data Publicação:" class="col-md-6" value="{{ $banner ? $banner->scheduled_date : ''}}" enable-old-support>
    ...
    <x-adminlte-input-date name="expire_date" :config="$config" placeholder="Escolha a data"
        label="Data Finalização:" class="col-md-6"  value="{{ $banner ? $banner->expire_date : ''}}" enable-old-support>
        <x-slot name="appendSlot">
            <x-adminlte-button icon="fas fa-lg fa-calendar"
...
<x-adminlte-input type="number" name="expire_impressions" label="Impressões/visitas:" placeholder="Insira somente números"  value="{{ $banner ? $banner->expire_impressions : ''}}" enable-old-support />
