                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_general">
                            @include('admin.brands.partials.tab_general')
                        </div>
                        <div class="tab-pane" id="tab_seo">
                            @include('admin.brands.partials.tab_seo')
                        </div>
                    </div>
...
<div class="box-footer">
     <a href="{{ route('admin.brands.index') }}" class="btn btn-warning"><i class="fa fa-times"></i> Cancelar</a>
