<div class="row">
    <div class="col-md-12">
        <x-adminlte-select name="parent_id" label="Pai:" enable-old-support>
        ...
        <x-adminlte-input name="name" label="Nome:*" value="{{ $category->name ?? '' }}" enable-old-support />
        @php
            $config = [
        ...
        <x-adminlte-input name="order" label="Ordem:*" type="number" value="{{ $category->order ?? '' }}"
            enable-old-support />
    </div>
</div>
