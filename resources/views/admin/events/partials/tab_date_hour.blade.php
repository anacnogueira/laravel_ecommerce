<input type="hidden" name="all_event_dates" id="all-event-dates" value="{{ isset($event->eventDates)  ? json_encode($event->eventDates) : '' }}" />
@php
...
<div class="row">
 	<div class="col-md-12">
        <div class="row">
            ...
            <x-adminlte-input-date name="end_hour" id="end_hour" placeholder="00:00" :config="$config_hour" fgroup-class="col-md-2">
                <x-slot name="appendSlot">
                    <x-adminlte-button icon="fa fa-lg fa-clock"
