    ...
    @php
        ...
        foreach($comments  as $key => $comment) {
            ...
            $data[$key] = [
                ...
                $comment->contact ? $comment->contact->name : $comment->name,
                $comment->rate,
                $comment->created,
                $status,
                '<nobr><a href="'. route('admin.comments.edit', $comment->id).'" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar">
                ...
                <a href="'.route('admin.comments.show', $comment->id) .'" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Detalhes">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header"> <a href="{{ route('admin.comments.create') }}" class="btn btn-sm btn-primary">
                    <i class="fa fa-lg fa-fw fa-file"></i> Adicionar
                </a></div>
                <div class="card-body">
                    <x-adminlte-datatable id="table-comment" :heads="$heads" head-theme="light" hoverable bordered with-buttons>
