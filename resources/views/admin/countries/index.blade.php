    ...
    @php
        ...
        foreach($countries  as $key => $country) {
            ...
            $data[$key] = [
                ...
                '<nobr><a href="'. route('admin.countries.edit', $country->id).'" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar">
                ...
                <a href="'.route('admin.countries.show', $country->id) .'" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Detalhes">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <x-adminlte-datatable id="table-country" :heads="$heads" head-theme="light" hoverable bordered with-buttons>
