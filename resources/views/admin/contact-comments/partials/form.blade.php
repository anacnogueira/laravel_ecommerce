...
@php
    $config = [
        'state' => (isset($comment->status) && $comment->status == 'S') || !isset($comment) ? true : false,
    ];
...
<a href="{{ route('admin.customers.comments.index', $customer->id) }}" class="btn btn-warning"><i class="fa fa-times"></i> Cancelar</a>
